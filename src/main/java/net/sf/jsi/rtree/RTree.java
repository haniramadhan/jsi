...
public class RTree implements SpatialIndex, Serializable {
  ...
  private final static int DEFAULT_MAX_NODE_ENTRIES = 16;
  private final static int DEFAULT_MIN_NODE_ENTRIES = 4;
  int maxNodeEntries;
  int minNodeEntries;
  ...
  /**
   * @see net.sf.jsi.SpatialIndexnearest(Point, TIntProcedure, double)
   */
  ...
  /**
   * @see net.sf.jsi.SpatialIndex#nearestNUnsorted(Point, TIntProcedure, int, double)
   */
  ...
  /**
   * @see net.sf.jsi.SpatialIndex#nearestN(Point, TIntProcedure, int, double)
   */
